...
<body>
  ...
  <p class=\"muted\">Private hub state on the local store. <a href=\"/inbox\">Open inbox</a> · <a href=\"/projects/research-writing/board\">Open projects</a> · <a href=\"/drop-folders/view\">Open drop folders</a></p>
  <div class=\"grid\">
    <section class=\"card\">
      <h2>Store Summary</h2>
